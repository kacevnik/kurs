...
?>
<section class="fw-main-row <?php echo esc_attr($section_extra_classes).$kdv_custom_stile; ?>"<?php echo $kdv_custom_id; ?> <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
